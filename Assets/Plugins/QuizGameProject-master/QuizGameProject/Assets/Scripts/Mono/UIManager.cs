...
public class UIManager : MonoBehaviour {
    ...
    void UpdateResUI(ResolutionScreenType type, int score)
    {
        ...
        switch (type)
        {
            case ResolutionScreenType.Correct:
                ...
                uIElements.ResolutionStateInfoText.text = "BETUL!";
            ...
            case ResolutionScreenType.Finish:
                ...
                uIElements.ResolutionStateInfoText.text = "MARKAH AKHIR";

                StartCoroutine(CalculateScore());
                uIElements.FinishUIElements.gameObject.SetActive(true);
                uIElements.HighScoreText.gameObject.SetActive(true);
                uIElements.HighScoreText.text = ((highscore > events.StartupHighscore) ? "<color=yellow>new </color>" : string.Empty) + "MARKAH TERTINGGI: " + highscore;
                break;
        }
    }
    ...
    void UpdateScoreUI()
    {
        uIElements.ScoreText.text = "MARKAH: " + events.CurrentFinalScore;
    }
}